...
object GameMode{
  ...
  def strategy_easy =   new Field(12, 4, Stone("E"), HintStone(" "))
  def strategy_medium = new Field(10, 4, Stone("E"), HintStone(" "))
  def strategy_hard =   new Field(10, 5, Stone("E"), HintStone(" "))
  def strategy_extrem = new Field(8, 5,  Stone("E"), HintStone(" "))
